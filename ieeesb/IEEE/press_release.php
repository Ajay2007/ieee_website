...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main_content">
		...
		<div id="templatemo_content">
        	<div id="accordion">
              <h3 style="font-weight:800; font-size: 20px; background-color:#abcdef"> Press Release</h3>
              <div>
                                    
                    <p>
					<ul style = "list-style-type:square">
					
					<li><a target="_blank" href="documents/Press Release - technikwiz-16.pdf"><span style="color: #3366FF;text-decoration: underline;float: left;"> IEEE Technikwiz'16 </a></li><br>
