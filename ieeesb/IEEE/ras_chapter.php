    ...
    <div id="templatemo_main_content">
		...
		<div class="sidebar_content_box ">
			...
			<h2><a href="#"> IEEE Robotics & Automation Society (RAS) SB Chapter - IIITA (SBC14321A) </a></h2>
				<div>
				<h3><a href="#">Office Bearers (2017-2018) </a></h3>
					<table width="100%" border="0">
						<tr>
						  <td>
						  <h4>Padmakar Pandey (Chairperson)<h4><br>
						  </td>
						</tr>
			          </table>
				</div>
			...
			<h3><a href="#">Office Bearers (2017-2018) </a></h3>
				<div>
					<table width="100%" border="0">
						<tr>
						  <td>
							Padmakar Pandey (Chairperson)<br>
							Venkat Beri (Vice Chair)<br>
							Shruti Jaiswal (Treasurer)<br>
							Akshat Aggarwal (Secretary)<br>
							Santosh B (Joint Secretary)<br><br>
