...
<div id="templatemo_wrapper">
    ...
    <!--		<h3><b>vkj Student Volunteers (2017-18)</b><h3>    -->  
 
        <div id="templatemo_content">

			<div id="accordion"> 
				<h2><a href="#">Publication Committee</a></h2>
				<div>
				...
				<tr>
		              	<td><img src="images/professional team/Anushree_Goswami.jpg" width="80" height="100" style="border-radius:50%;"/></td>
			              <td><div><h4><b><a target="_blank" href = "#">Anushree Goswami</b></a></h4></div>
			                Role : Co-ordinator<br>
					StMIEEE: 94189182<br>
			                Email: lit2016005@iiita.ac.in, Mob No: (+91)7084456074<br>
					B.Tech IT<br>
			              </td>
		            	</tr>
					...
					<tr>
						<td>
							...
							1. Ms. Navyasri Alapati (iec2016045)<br>
							2. Ms. Priyanka Karnati (iit2016080)<br>
							3. Ms. Elaine Mary Rose (iit2016130)<br>
							4. Mr. Saicharan Redy Shankar (bim2016002)<br>
				...
				<table width="100%" border="0">
					...
					<tr>
		              		<td><img src="images/professional team/generic.jpg" width="100" height="100" /></td>
			              <td><div><h4><b><a target="_blank" href = "#">Sandeep Kumar Singh</b></a></h4></div>
			                Role : Coordinator<br>
			                StMIEEE: - 94015220 <br>
			                Email: iit2015014@iiita.ac.in <br>
					B.Tech IT<br><br>
			              </td>
				</tr>
		            </table> 
					...
					<td>
							<div><h4><b>Members - </b></h4></div>
							1. Himanshu Kr. Upadhyay (ECM2015004)<br>
							2. Srishti Agrawal (ECM2016001)<br>
							3. Vinit Mankar (IEC2016066)<br>
							4. Shubhangi Nigam (IIT2016023)<br>
							5. Aswanth k (IIT2016105)<br>
							6. Ashwin Vb (IIT2016106)<br>
							7. Samanwaya Kr. Maurya (ITM2016003)<br>
							8. Ishani Mishra (IWM2015008)
						</td>
					</tr>
				</table>
				</div>  	
				...
				<table width="100%" border="0">
					...
					<tr>
		              <td><img src="images/professional team/generic.jpg" width="100" height="100" /></td>
			              <td><div><h4><b><a target="_blank" href = "#">Sonal Gupta</b></a></h4></div>
			                Role : Coordinator<br>
			                StMIEEE: - 93633181<br>
			                Email: iec2015050@iiita.ac.in <br>
					B.Tech ECE<br><br>
			              </td>
					<tr>
					...
					<tr>
		              <td><img src="images/professional team/generic.jpg" width="100" height="100" /></td>
			              <td><div><h4><b><a target="_blank" href = "#">Jayesh Patil</b></a></h4></div>
			                Role : Coordinator<br>
			                StMIEEE: - 93635616<br>
			                Email: iit2015064@iiita.ac.in <br>
					B.Tech IT<br><br>
			              </td>
					</tr>
		            </table> 
					...
					<tr>
		              		<td>
		              				<div><h4><b>Members - </b></h4></div>
		              				1. Sagar Kumar (iit2015020)<br>
							2. Saumya Verma (BIM2016001)<br>
							3. Prachi Shankar (IEC2016010)<br>
							4. Chahak Sharma (IIT2016103)<br>
							5. Ridam Arora (IIT2016134)<br>
							6. Aditi Bansal (ITM2016005)<br>
							7. Aditi Agrawal((IIM2016001)
			          	</td>
		            		</tr>
				...
				<table width="100%" border="0">
		            	...
		            	<tr>
		              <td><img src="images/professional team/generic.jpg" width="100" height="100" /></td>
			              <td><div><h4><b><a target="_blank" href = "#">Sushmita Gayen</b></a></h4></div>
			                Role : Coordinator<br>
			                StMIEEE: - 94022933 <br>
			                Email: iec2015024@iiita.ac.in <br>
					B.Tech ECE<br><br>
			              </td>
					<tr>	
					...
					<tr>
		              <td><img src="images/professional team/generic.jpg" width="100" height="100" /></td>
			              <td><div><h4><b><a target="_blank" href = "#">Aryan Aditya Singh</b></a></h4></div>
			                Role : Coordinator<br>
			                StMIEEE: - 94070458<br>
			                Email: iit2014097@iiita.ac.in <br>
					B.Tech IT<br><br>
			              </td>
					</tr>
		            </table> 
					...
					<table width="100%" border="0">	
		            		...
		            		<tr>
		              		<td>
		              			<div><h4><b>Members - </b></h4></div>
		              			1. Aanandita Dhawan (IEC2016052)<br>
						2. Raghvendra kumar (IIM2016004)<br>
						3. Akansha Kumari (IMM2016006)
					</td>
		            		</tr>
				...
				<table width="100%" border="0">
					...
					<tr>
		              <td><img src="images/professional team/generic.jpg" width="100" height="100" /></td>
			              <td><div><h4><b><a target="_blank" href = "#">Pranuj Baranwal</b></a></h4></div>
			                Role : Coordinator<br>
			                StMIEEE: 94123583<br>
			                Email: iec2015003@iiita.ac.in <br>
					B.Tech ECE<br><br>
			              </td>
					<tr>
					...
					<tr>
		              <td><img src="images/professional team/generic.jpg" width="100" height="100" /></td>
			              <td><div><h4><b><a target="_blank" href = "#">Nishtha Sharma</b></a></h4></div>
			                Role : Coordinator<br>
			                StMIEEE: - 94026505<br>
			                Email: iit2015039@iiita.ac.in <br>
					B.Tech IT<br><br>
			              </td>
					</tr>
		            </table> 
					...
					<tr>
		              		<td>
		              			<div><h4><b>Members - </b></h4></div>
		              			1. Arunav Bhatnagar (IEC2015084)<br>
						2. Sukhavasi Meghana (IEC2016032)<br>
						3. Komal Goenka (IIT2016144)<br>
						4. Ajitesh Gupta (IMM2016003)
					</td>
		            		</tr>
				...
				<h2><a href="#">Web Management and Graphics Committee</a></h2>
				<div>
				<table width="100%" border="0">

					<tr>
		              <td><img src="images/professional team/generic.jpg" width="100" height="100" /></td>
			              <td><div><h4><b><a target="_blank" href = "#">Jay Tibrewal</b></a></h4></div>
			                Role : Coordinator<br>
			                StMIEEE: - 93890733<br>
			                Email: iit2014010@iiita.ac.in <br>
					B.Tech IT<br><br>
			              </td>
					<tr>
					...
					<tr>
		              		<td>
		              			<div><h4><b>Members - </b></h4></div>
		              			1. Kundan Sen (iit2014105)<br>
						2. Sandeep Kumar Sharma (IIT2014073)<br>
						3. Amit Vijay (IIT2014110)<br>
						4. Anupam Dagar (IIT2016128)<br>
						5. Pentakota Dinesh (IIT2015060)<br>
						6. Naveen Kewalramani (IEC2015016)
					</td>
			        	</tr>
				...
				<table width="100%" border="0">
				<tr>
		              <td><img src="images/professional team/Sapna_Nirapure.jpg" width="100" height="100" style="border-radius:70%;"/></td>
			              <td><div><h4><b><a target="_blank" href = "#">Sapna Nirapure</b></a></h4></div>
			                Role : Coordinator<br>
			                GSMIEEE: 94179602<br>
			                Email: pis2015002@iiita.ac.in<br>
					Integrated PhD (Signal Processing) <br>
			              </td>
					</tr>
		            </table> 
					...
					<tr>
		              		<td>
		              			<div><h4><b>Members - </b></h4></div>
		              			1. Himanshul Patel (ECM2015003)<br>
						2. Vivek Arya (IEC2015014)<br>
						3. B.Sindhu (IIT2016044)<br>	
						4. Surabhi Gogte (IIT2016053)
					</td>
			        	</tr>
				...
				<table width="100%" border="0">
					...
					<tr>
		              <td><img src="images/professional team/generic.jpg" width="100" height="100" /></td>
			              <td><div><h4><b><a target="_blank" href = "#">Bikey Saha Rouniyar</b></a></h4></div>
			                Role : Coordinator<br>
			                StMIEEE: 93890826<br>
			                Email: iec2015001@iiita.ac.in <br>
					B.Tech ECE<br><br>
			              </td>
					<tr>
					...
					<tr>
		              <td><img src="images/professional team/generic.jpg" width="100" height="100" /></td>
			              <td><div><h4><b><a target="_blank" href = "#">Saurabh Pathak</b></a></h4></div>
			                Role : Coordinator<br>
			                StMIEEE: - 93892634 <br>
			                Email: iis2015007@iiita.ac.in <br>
					IIS <br><br>
			              </td>
					</tr>
		            </table> 
					...
					<tr>
		              		<td>
		              			<div><h4><b>Members - </b></h4></div>
		              			1. Shefali verma (IIT2015031)<br>
						2. Niharika Gali (ITM2016007)<br>
						3. Swapnil Yadav (LIT2016025)
					</td>
			        	</tr>
